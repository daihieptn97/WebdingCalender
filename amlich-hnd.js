...
function printStyle() {
    ...
    res += '  .thang {font-size: ' + fontSize + '; padding:0; margin:0; line-height:100%; font-family:Tahoma,Verdana,Arial;border-collapse: collapse;  }\n';//table-layout:fixed
...
function printTable(mm, yy) {
    ...
    var res = "";
    res += ('<table class="thang" border="1" cellpadding="1" cellspacing="2" width="' + PRINT_OPTS.tableWidth + '">\n');
    res += printHead(mm, yy);
    for (i = 0; i < 6; i++) {
        res += ("<tr>\n");
        for (j = 0; j < 7; j++) {
